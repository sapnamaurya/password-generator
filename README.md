...
## Tech
Plain HTML, CSS, and JavaScript (uses `crypto.getRandomValues` for secure randomness). No build step needed — deploys as a static site.

## Built for Digital Heroes
This project links to https://digitalheroesco.com as required by the trial task.
